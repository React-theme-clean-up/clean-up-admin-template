...
renderGridSort(ReactDOM, document.getElementById("GridSort"));
            ...
            <div className="card">
              <div className="card-header">
                <h5 className="mb-0 mr-3 d-inline-block text-black">
                  <strong>Grid</strong>
                  <a href="https://ant.design/components/grid/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-2">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">From the stack to the horizontal arrangement.
...
<div className="card" id="components-grid-demo-flex-order">
  <div className="card-header">
    ...
    <div className="card-body pb-0">To change the element sort by Flex layout order.
</div>
    <div className="card-body pb-0">
...
<div className="card" id="components-grid-demo-gutter">
  <div className="card-header">
    ...
    <div className="card-body pb-0">You can use the <code>{'gutter'}</code> property of <code>{'Row'}</code> as grid spacing, we recommend set it to <code>{'(16 + 8n) px'}</code>. (<code>{'n'}</code> stands for natural number.)
...
<div className="card" id="components-grid-demo-playground">
  <div className="card-header">
    ...
    <div className="card-body pb-0">A simple playground for column count and gutter.
</div>
    <div className="card-body pb-0">
...
<div className="card" id="components-grid-demo-responsive">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Referring to the Bootstrap [responsive design] (http://getbootstrap.com/css/#grid-media-queries), here preset five dimensions: <code>{'xs'}</code> <code>{'sm'}</code> <code>{'md'}</code> <code>{'lg'}</code> <code>{'xl'}</code>.
</div>
    <div className="card-body pb-0">
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Flex child elements vertically aligned.
</div>
    <div className="card-body pb-0">
...
<div className="card" id="components-grid-demo-flex">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Use <code>{'row-flex'}</code> define <code>{'flex'}</code> layout, its child elements depending on the value of the <code>{'start'}</code>,<code>{' center'}</code>, <code>{'end'}</code>,<code>{' space-between'}</code>, <code>{'space-around'}</code>, which are defined in its parent node layout mode.
</div>
    <div className="card-body pb-0">
      <div id="GridFlex" />
    </div>
...
<div className="card" id="components-grid-demo-offset">
  <div className="card-header">
    ...
    <div className="card-body pb-0"><code>{'Offset'}</code> can set the column to the right side. For example, using <code>{'offset = {4}'}</code> can set the element shifted to the right four columns width.
</div>
    <div className="card-body pb-0">
      <div id="GridOffset" />
    </div>
...
<div className="card" id="components-grid-demo-responsive-more">
  <div className="card-header">
    ...
    <div className="card-body pb-0"><code>{'span'}</code> <code>{'pull'}</code> <code>{'push'}</code> <code>{'offset'}</code> <code>{'order'}</code> property can be embedded into <code>{'xs'}</code> <code>{'sm'}</code> <code>{'md'}</code> <code>{'lg'}</code> <code>{'xl'}</code> properties to use,
...
<div className="card" id="components-grid-demo-sort">
  <div className="card-header">
    ...
    <div className="card-body pb-0">By using <code>{'push'}</code> and<code>{' pull'}</code> class you can easily change column order.
</div>
    <div className="card-body pb-0">
      <div id="GridSort" />
    </div>
