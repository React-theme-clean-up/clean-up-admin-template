...
class NotificationPageItems extends React.Component {
  componentDidMount() {
    ...
    renderNotificationPageCustomicon(
      ReactDOM,
      document.getElementById('NotificationPageCustomicon'),
    )
    renderNotificationPageCustomstyle(
      ReactDOM,
      document.getElementById('NotificationPageCustomstyle'),
    )
