                        ...
                        <Collapse bordered={false} defaultActiveKey={['1']}>
                          ...
                          >
                            <div>
                              ...
                              button, <code>{'dashed'}</code> button and <code>{'danger'}</code>{' '}
                              button in antd. > <code>{'danger'}</code> is supported after{' '}
                              <code>{'antd@2.7'}</code>.
                            </div>
                          </Panel>
                          <Panel
                    ...
                    <div className="card" id="components-button-demo-icon">
                      ...
                      <div className="cat__ant-component-collapse-descr">
                        <Collapse bordered={false} defaultActiveKey={['1']}>
                          ...
                          >
                            <div>
                              <code>{'Button'}</code> components can contain an{' '}
                              <code>{'Icon'}</code>. This is done by setting the{' '}
                              <code>{'icon'}</code> property or placing an <code>{'Icon'}</code>{' '}
                              component within the <code>{'Button'}</code>
                              ...
                              rather than using the <code>{'icon'}</code> property.
                            </div>
                          </Panel>
                          <Panel
                            header={
                    ...
                    <div className="card" id="components-button-demo-multiple">
                      ...
                      <div className="cat__ant-component-collapse-descr">
                        <Collapse bordered={false} defaultActiveKey={['1']}>
                          ...
                          >
                            <div>
                              If you need several buttons, we recommend that you use 1 primary
                              button + n secondary buttons, and if there are more than three
                              operations, you can group some of them into{' '}
                              <code>{'Dropdown.Button'}</code>.
                            </div>
                          </Panel>
                          <Panel
                            header={
                        ...
                        <Collapse bordered={false} defaultActiveKey={['1']}>
                          ...
                          >
                            <div>
                              ...
                              components into a <code>{'Button.Group'}</code>. The{' '}
                              <code>{'size'}</code> can be set to <code>{'large'}</code>,{' '}
                              <code>{'small'}</code> or left unset resulting in a default size.
                            </div>
                          </Panel>
                          <Panel
                            header={
                        ...
                        <Collapse bordered={false} defaultActiveKey={['1']}>
                          ...
                          >
                            <div>
                              ...
                              size. If a large or small button is desired, set the{' '}
                              <code>{'size'}</code> property to either <code>{'large'}</code> or{' '}
                              <code>{'small'}</code> respectively. Omit the <code>{'size'}</code>{' '}
