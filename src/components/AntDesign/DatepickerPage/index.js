...
class DatepickerPageItems extends React.Component {
  componentDidMount() {
    ...
    renderDatepickerPageDisableddate(
      ReactDOM,
      document.getElementById('DatepickerPageDisableddate'),
    )
    ...
    renderDatepickerPagePresettedranges(
      ReactDOM,
      document.getElementById('DatepickerPagePresettedranges'),
    )
