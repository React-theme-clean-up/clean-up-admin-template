        ...
        <section className="card">
          <div className="card-header">
            <span className="cat__core__title">
              ...
              <a href="http://v4-alpha.getbootstrap.com/content/typography/" target="_blank" className="btn btn-sm btn-primary ml-2">Official Documentation <i className="icmn-link ml-1"></i></a>
            </span>
          </div>
          <div className="card-body">
            <div className="row">
              <div className="col-lg-6">
                <div className="mb-5">
                  ...
                  <p className="text-muted">All HTML headings, <code>&lt;h1&gt;</code> through <code>&lt;h6&gt;</code>,
                  ...
                  <h1>h1. Bootstrap heading <span className="badge badge-default">LABEL</span></h1>
                  <h2>h2. Bootstrap heading <span className="badge badge-primary">LABEL</span></h2>
                  <h3>h3. Bootstrap heading <span className="badge badge-info">LABEL</span></h3>
                  <h4>h4. Bootstrap heading <span className="badge badge-danger">LABEL</span></h4>
                  <h5>h5. Bootstrap heading <span className="badge badge-success">LABEL</span></h5>
                  <h6>h6. Bootstrap heading <span className="badge badge-warning">LABEL</span></h6>
                </div>
              </div>
              <div className="col-lg-6">
                <div className="mb-5">
                  ...
                  <p className="text-muted">Create lighter, secondary text in any heading with a generic <code>&lt;small&gt;</code> tag or the <code>.small</code> class</p>
                  <h1><i className="icmn-home mr-3" aria-hidden="true"></i>Bootstrap heading
                    <span className="text-muted">Secondary text</span>
                  </h1>
                  <h2><i className="icmn-home mr-3" aria-hidden="true"></i>Bootstrap heading
                    <span className="text-muted">Secondary text</span>
                  </h2>
                  <h3><i className="icmn-home mr-3" aria-hidden="true"></i>Bootstrap heading
                    <span className="text-muted">Secondary text</span>
                  </h3>
                  <h4><i className="icmn-home mr-3" aria-hidden="true"></i>Bootstrap heading
                    <span className="text-muted">Secondary text</span>
                  </h4>
                  <h5><i className="icmn-home mr-3" aria-hidden="true"></i>Bootstrap heading
                    <span className="text-muted">Secondary text</span>
                  </h5>
                  <h6><i className="icmn-home mr-3" aria-hidden="true"></i>Bootstrap heading
                    <span className="text-muted">Secondary text</span>
                  </h6>
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-4">
                <div className="mb-5">
                  ...
                  <p className="text-muted">Remove the default default styles and left margin on list
            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="mb-5">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <i className="icmn-checkmark2 mr-2" aria-hidden="true"></i>
                    ...
                    <li>
                      <i className="icmn-checkmark2 mr-2" aria-hidden="true"></i>Faucibus porta lacus
                      fringilla vel
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <a data-toggle="collapse" href="#exampleSubmenu" aria-controls="exampleSubmenu" aria-expanded="false">
                        <i className="icmn-checkmark2 mr-2" aria-hidden="false"></i>
                        Nulla volutpat aliquam velit
                      </a>
              ...
              <div className="col-lg-4">
                <div className="mb-5">
                  ...
                  <p className="text-muted">Place all list items on a single line with <code>display: inline-block;</code> and some light padding</p>
            ...
            <div className="row">
              ...
              <div className="col-lg-8">
                <div className="mb-5">
                  ...
                  <p className="text-muted">Use the well as a simple effect on an element to give it an inset
                    effect</p>
                  <dl className="row">
            ...
            <div className="row">
              <div className="col-lg-12">
                ...
                <p className="text-muted mb-3">Add a <code>&lt;footer className="blockquote-footer"&gt;</code> for identifying the source. Wrap the name of the source work in <code>&lt;cite&gt;</code>.</p>
                <div className="row">
