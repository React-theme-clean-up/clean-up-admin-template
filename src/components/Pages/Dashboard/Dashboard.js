          ...
          name: (
            <span>
              {record.name.split(reg).map((text, i) => (
                i > 0 ? [<span style={{backgroundColor: 'yellow'}} >{match[0]}</span>, text] : text
              ))}
            </span>
          ),
        };
            ...
            <div className="card">
              <div className="card-header">
                ...
                <span className="mr-2 nowrap">
                  <span className="cat__core__donut cat__core__donut--primary"></span>
                  Girls
                </span>
                <span className="mr-2 nowrap">
                  <span className="cat__core__donut cat__core__donut--success"></span>
                  Guns
                </span>
                <span className="mr-2 nowrap">
                  <span className="cat__core__donut cat__core__donut--yellow"></span>
                  Drugs
                </span>
              </div>
              <div className="card-body">
                  ...
                  <div className="col-lg-6">
                    <Carousel effect="scrollx" autoplay="true">
                      <div className="bg-default">
                        <a href="javascript: void(0);" className="cat__core__widget__3__body text-white">
