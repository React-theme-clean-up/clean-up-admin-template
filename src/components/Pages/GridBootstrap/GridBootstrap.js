    ...
    return (
      <div>
        ...
        <span className="cat__core__title">
            ...
            <a href="http://v4-alpha.getbootstrap.com/layout/grid/" target="_blank" className="btn btn-sm btn-primary ml-2">Official Documentation <i className="icmn-link ml-1"></i></a>
        </span>
          </div>
          <div className="card-body">
            <p>While Bootstrap uses aaa<code>em</code>s or <code>rem</code>s for defining most sizes, <code>px</code>s are used for grid breakpoints and container widths. This is because the viewport width is in pixels and does not change with the <a href="https://drafts.csswg.org/mediaqueries-3/#units">font size</a>.</p>
        ...
        <span className="cat__core__title">
          ...
          <div className="card-body">
            <p>Don’t want your columns to simply stack in smaller devices? Use the extra small and medium device grid classes by adding <code>.col-xs-*</code> and <code>.col-md-*</code> to your columns. See the example below for a better idea of how it all works.</p>
            <br />
            <div className="row">
              <div className="col-xs-12 col-md-8">
                <div className="w100 mb-4 px-3 py-2 bg-default text-white">.col-xs-12 .col-md-8</div>
              </div>
