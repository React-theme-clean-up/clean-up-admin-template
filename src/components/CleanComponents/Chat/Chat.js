...
const Message = ({chat, user}) => (
  <div className={`clearfix chat__item ${user === chat.username ? "chat__item--left" : "chat__item--right"}`}>
    ...
    return (
      <div className="chat">
        ...
        <form className="form-group mt-4 mb-0">
          <textarea className="form-control adjustable-textarea" placeholder="Type message..."></textarea>
          <div className="mt-3">
