            ...
            <div className="card">
              <div className="card-header">
                <h5 className="mb-0 mr-3 d-inline-block text-black">
                  <strong>Rate</strong>
                  <a href="https://ant.design/components/rate/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-2">
...
<div className="card" id="components-rate-demo-clear">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Support set allow to clear star when click again.
</div>
    <div className="card-body pb-0">
      <div id="RateClear" />
    </div>
...
<div className="card" id="components-rate-demo-half">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Support select half star.
</div>
    <div className="card-body pb-0">
      <div id="RateHalf" />
    </div>
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Replace the default star to other character like alphabet, digit, iconfont or even Chinese word.
</div>
    <div className="card-body pb-0">
...
<div className="card" id="components-rate-demo-disabled">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Read only, can't use mouse to interact.
</div>
    <div className="card-body pb-0">
      <div id="RateDisabled" />
    </div>
...
<div className="card" id="components-rate-demo-text">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Add copywriting in rate components.
</div>
    <div className="card-body pb-0">
      <div id="RateText" />
    </div>
