...
class RadioPageItems extends React.Component {
  componentDidMount() {
    ...
    renderRadioPageRadiogroupoptions(
      ReactDOM,
      document.getElementById('RadioPageRadiogroupoptions'),
    )
    renderRadioPageRadiogroupwithname(
      ReactDOM,
      document.getElementById('RadioPageRadiogroupwithname'),
    )
