...
renderMessageOther(ReactDOM, document.getElementById("MessageOther"));
            ...
            <div className="card">
              <div className="card-header">
                <h5 className="mb-0 mr-3 d-inline-block text-black">
                  ...
                  <a href="https://ant.design/components/message/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-2">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Customize message display duration from default <code>{'3s'}</code> to <code>{'10s'}</code>.
</div>
...
<div className="card" id="components-message-demo-loading">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Display a global loading indicator, which is dismissed by itself asynchronously.
</div>
    <div className="card-body pb-0">
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Normal messages as feedbacks.
</div>
    <div className="card-body pb-0">
      <div id="MessageInfo" />
    </div>
...
<div className="card" id="components-message-demo-other">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Messages of success, error and warning types.
</div>
    <div className="card-body pb-0">
      <div id="MessageOther" />
    </div>
