...
renderDividerVertical(ReactDOM, document.getElementById("DividerVertical"));
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <a href="https://ant.design/components/divider/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Divider default type is <code>{'horizontal'}</code>. Support inner text inside Divider.
</div>
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Use <code>{'type="vertical"'}</code> make it vertical.
</div>
    <div className="card-body pb-0">
