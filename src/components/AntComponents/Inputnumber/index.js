...
renderInputnumberSize(ReactDOM, document.getElementById("InputnumberSize"));
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <a href="https://ant.design/components/input-number/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Numeric-only input box.
</div>
...
<div className="card card--example" id="components-input-number-demo-disabled">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Click the button to toggle between available and disabled states.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-input-number-demo-size">
  <div className="card-header">
    ...
    <div className="card-body pb-0">There are three sizes available to a numeric input box. By default, the size is <code>{'32px'}</code>. The two additional sizes are <code>{'large'}</code> and <code>{'small'}</code> which means <code>{'40px'}</code> and <code>{'24px'}</code>, respectively.
</div>
    <div className="card-body pb-0">
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">A numeric-only input box whose values can be increased or decreased using a decimal step. The number of decimals (also known as precision) is determined by the step prop.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-input-number-demo-formatter">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Display value within it's situation with <code>{'formatter'}</code>, and we usually use <code>{'parser'}</code> at the same time.
</div>
    <div className="card-body pb-0">
