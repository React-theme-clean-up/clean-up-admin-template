...
renderCascaderSize(ReactDOM, document.getElementById("CascaderSize"));
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <a href="https://ant.design/components/cascader/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Cascade selection box for selecting province/city/district.
</div>
...
<div className="card card--example" id="components-cascader-demo-custom-render">
  <div className="card-header">
    ...
    <div className="card-body pb-0">For instance, add an external link after the selected value.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-cascader-demo-default-value">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Specifies default value by an array.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-cascader-demo-hover">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Hover to expand sub menu, click to select option.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-cascader-demo-search">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Search and select options directly.

> Now, <code>{'Cascader[showSearch]'}</code> doesn't support search on server, more info [#5547](https://github.com/ant-design/ant-design/issues/5547)
</div>
    <div className="card-body pb-0">
...
`}
                  ...
                  <div className="col-xl-6 col-lg-12">
                    <div className="card card--example" id="components-cascader-demo-change-on-select">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize">Change on select</strong>
    </h5>
  </div>
    <div className="card-body pb-0">Allow only select parent options.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-cascader-demo-custom-trigger">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize">Custom trigger</strong>
    </h5>
  </div>
    <div className="card-body pb-0">Separate trigger button and result.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-cascader-demo-disabled-option">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize">Disabled option</strong>
    </h5>
  </div>
    <div className="card-body pb-0">Disable option by specifying the <code>{'disabled'}</code> property in <code>{'options'}</code>.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-cascader-demo-lazy">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Load options lazily with <code>{'loadData'}</code>.

> Note: <code>{'loadData'}</code> cannot work with <code>{'showSearch'}</code>.
</div>
    <div className="card-body pb-0">
      <div id="CascaderLazy" />
    </div>
...
<div className="card card--example" id="components-cascader-demo-size">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Cascade selection box of different sizes.
</div>
    <div className="card-body pb-0">
      <div id="CascaderSize" />
    </div>
