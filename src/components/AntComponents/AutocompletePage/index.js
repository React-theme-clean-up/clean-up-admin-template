...
renderAutocompletePageCertaincategory(ReactDOM, document.getElementById("AutocompletePageCertaincategory"));
renderAutocompletePageCustom(ReactDOM, document.getElementById("AutocompletePageCustom"));
renderAutocompletePageNoncasesensitive(ReactDOM, document.getElementById("AutocompletePageNoncasesensitive"));
renderAutocompletePageOptions(ReactDOM, document.getElementById("AutocompletePageOptions"));
renderAutocompletePageUncertaincategory(ReactDOM, document.getElementById("AutocompletePageUncertaincategory"));
