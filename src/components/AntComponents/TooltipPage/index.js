...
class TooltipPageItems extends React.Component {
  ...
  componentDidMount() {
    renderTooltipPageArrowpointatcenter(ReactDOM, document.getElementById("TooltipPageArrowpointatcenter"));
renderTooltipPageAutoadjustoverflow(ReactDOM, document.getElementById("TooltipPageAutoadjustoverflow"));
