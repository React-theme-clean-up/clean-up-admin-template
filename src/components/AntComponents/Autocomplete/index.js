            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <a href="https://ant.design/components/auto-complete/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
...
`}
                  ...
                  <div className="col-xl-6 col-lg-12">
                    <div className="card card--example" id="components-auto-complete-demo-certain-category">
  <div className="card-header">
    <h5 className="text-black">
...
<div className="card card--example" id="components-auto-complete-demo-non-case-sensitive">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize"></strong>
    </h5>
...
<div className="card card--example" id="components-auto-complete-demo-uncertain-category">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize"></strong>
    </h5>
