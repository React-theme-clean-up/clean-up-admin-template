...
renderInputTooltip(ReactDOM, document.getElementById("InputTooltip"));
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  <strong>Input</strong>
                  <a href="https://ant.design/components/input/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Using pre & post tabs example.
</div>
...
<div className="card card--example" id="components-input-demo-basic">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Basic usage example.
</div>
    <div className="card-body pb-0">
      <div id="InputBasic" />
    </div>
...
<div className="card card--example" id="components-input-demo-presuffix">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Add prefix or suffix icons inside input.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-input-demo-size">
  <div className="card-header">
    ...
    <div className="card-body pb-0">There are three sizes of an Input box: <code>{'large'}</code> (40px)、<code>{'default'}</code> (32px) and <code>{'small'}</code> (24px).
...
<div className="card card--example" id="components-input-demo-tooltip">
  <div className="card-header">
    ...
    <div className="card-body pb-0">You can use the Input in conjunction with [Tooltip](/components/tooltip) component to create a Numeric Input, which can provide a good experience for extra-long content display.
</div>
    <div className="card-body pb-0">
      <div id="InputTooltip" />
    </div>
...
`}
                  ...
                  <div className="col-xl-6 col-lg-12">
                    <div className="card card--example" id="components-input-demo-autosize-textarea">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize">Autosizing the height to fit the content</strong>
    </h5>
  </div>
    <div className="card-body pb-0"><code>{'autosize'}</code> prop for a <code>{'textarea'}</code> type of <code>{'Input'}</code> makes the height to automatically adjust based on the content.
...
<div className="card card--example" id="components-input-demo-group">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Input.Group example
...
<div className="card card--example" id="components-input-demo-search-input">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Example of creating a search box by grouping a standard input with a search button, added in <code>{'2.5.0'}</code>.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-input-demo-textarea">
  <div className="card-header">
    ...
    <div className="card-body pb-0">For multi-line input.
</div>
    <div className="card-body pb-0">
