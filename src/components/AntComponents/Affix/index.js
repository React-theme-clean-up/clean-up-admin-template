            ...
            <div className="card">
              <div className="card-header">
                <h5 className="mb-0 mr-3 d-inline-block text-black">
                  <strong>Affix</strong>
                  <a href="https://ant.design/components/affix/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-2">
...
<div className="card" id="components-affix-demo-target">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Set a <code>{'target'}</code> for 'Affix', which is listen to scroll event of target element (default is <code>{'window'}</code>).
</div>
    <div className="card-body pb-0">
      <div id="AffixTarget" />
    </div>
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Callback with affixed state.
</div>
    <div className="card-body pb-0">
