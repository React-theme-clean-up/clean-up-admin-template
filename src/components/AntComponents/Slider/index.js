...
renderSliderVertical(ReactDOM, document.getElementById("SliderVertical"));
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <a href="https://ant.design/components/slider/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Basic slider. When <code>{'range'}</code> is <code>{'true'}</code>, display as dual thumb mode. When <code>{'disable'}</code> is <code>{'true'}</code>, the slider will not be interactable.
</div>
...
<div className="card card--example" id="components-slider-demo-icon-slider">
  <div className="card-header">
    ...
    <div className="card-body pb-0">You can add an icon beside the slider to make it meaningful.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-slider-demo-mark">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Using <code>{'marks'}</code> property to mark a graduated slider, use <code>{'value'}</code> or <code>{'defaultValue'}</code> to specify the position of thumb.
When <code>{'included'}</code> is false, means that different thumbs are coordinative.
when <code>{'step'}</code> is null, users can only slide the thumbs onto marks.
...
<div className="card card--example" id="components-slider-demo-vertical">
  <div className="card-header">
    ...
    <div className="card-body pb-0">The vertical Slider.
</div>
    <div className="card-body pb-0">
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">The <code>{'onChange'}</code> callback function will fire when the user changes the slider's value.
The <code>{'onAfterChange'}</code> callback function will fire when <code>{'onmouseup'}</code> fired.
</div>
    <div className="card-body pb-0">
      <div id="SliderEvent" />
    </div>
...
<div className="card card--example" id="components-slider-demo-input-number">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Synchronize with [InptNumber](/components/input-number/) component.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-slider-demo-tip-formatter">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Use <code>{'tipFormatter'}</code> to format content of <code>{'Toolip'}</code>. If <code>{'tipFormatter'}</code> is null, hide it.
</div>
    <div className="card-body pb-0">
