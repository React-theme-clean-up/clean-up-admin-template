...
renderTimepickerValue(ReactDOM, document.getElementById("TimepickerValue"));
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <a href="https://ant.design/components/time-picker/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">TimePicker of 12 hours format, with default format <code>{'h:mm:ss a'}</code>.
</div>
...
<div className="card card--example" id="components-time-picker-demo-basic">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Click <code>{'TimePicker'}</code>, and then we could select or input a time in panel.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-time-picker-demo-hide-column">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize">Hour and minute</strong>
    </h5>
  </div>
    <div className="card-body pb-0">While part of <code>{'format'}</code> is omitted, the corresponding column in panel will disappear, too.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-time-picker-demo-size">
  <div className="card-header">
    ...
    <div className="card-body pb-0">The input box comes in three sizes. large is used in the form, while the medium size is the default.
</div>
    <div className="card-body pb-0">
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Render addon contents to timepicker panel's bottom.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-time-picker-demo-disabled">
  <div className="card-header">
    ...
    <div className="card-body pb-0">A disabled state of the <code>{'TimePicker'}</code>.
...
<div className="card card--example" id="components-time-picker-demo-interval-options">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize">interval option</strong>
    </h5>
  </div>
    <div className="card-body pb-0">Show stepped options by <code>{'hourStep'}</code> <code>{'minuteStep'}</code> <code>{'secondStep'}</code>.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-time-picker-demo-value">
  <div className="card-header">
    ...
    <div className="card-body pb-0"><code>{'value'}</code> and <code>{'onChange'}</code> should be used together,
</div>
    <div className="card-body pb-0">
