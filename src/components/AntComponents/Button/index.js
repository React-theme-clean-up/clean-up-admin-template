...
renderButtonSize(ReactDOM, document.getElementById("ButtonSize"));
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <a href="https://ant.design/components/button/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">There are <code>{'primary'}</code> button, <code>{'default'}</code> button, <code>{'dashed'}</code> button and <code>{'danger'}</code> button in antd.
...
<div className="card card--example" id="components-button-demo-disabled">
  <div className="card-header">
    ...
    <div className="card-body pb-0">To mark a button as disabled, add the <code>{'disabled'}</code> property to the <code>{'Button'}</code>.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-button-demo-icon">
  <div className="card-header">
    ...
    <div className="card-body pb-0"><code>{'Button'}</code> components can contain an <code>{'Icon'}</code>. This is done by setting the <code>{'icon'}</code> property or placing an <code>{'Icon'}</code> component within the <code>{'Button'}</code>
...
<div className="card card--example" id="components-button-demo-multiple">
  <div className="card-header">
    ...
    <div className="card-body pb-0">If you need several buttons, we recommend that you use 1 primary button + n secondary buttons, and if there are more than three operations, you can group some of them into <code>{'Dropdown.Button'}</code>.
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Buttons can be grouped by placing multiple <code>{'Button'}</code> components into a <code>{'Button.Group'}</code>.
...
<div className="card card--example" id="components-button-demo-ghost">
  <div className="card-header">
    ...
    <div className="card-body pb-0"><code>{'ghost'}</code> property will make button's background transparent, it is common used in colored background.
</div>
    <div className="card-body pb-0">
      <div id="ButtonGhost" />
    </div>
...
<div className="card card--example" id="components-button-demo-loading">
  <div className="card-header">
    ...
    <div className="card-body pb-0">A loading indicator can be added to a button by setting the <code>{'loading'}</code> property on the <code>{'Button'}</code>.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-button-demo-size">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Ant Design supports a default button size as well as a large and small size.

If a large or small button is desired, set the <code>{'size'}</code> property to either <code>{'large'}</code> or <code>{'small'}</code> respectively. Omit the <code>{'size'}</code> property for a button with the default size.
</div>
    <div className="card-body pb-0">
      <div id="ButtonSize" />
    </div>
