...
renderTablePageCustomfilterpanel(ReactDOM, document.getElementById("TablePageCustomfilterpanel"));
...
renderTablePageFixedcolumnsheader(ReactDOM, document.getElementById("TablePageFixedcolumnsheader"));
...
renderTablePageRowselectionandoperation(ReactDOM, document.getElementById("TablePageRowselectionandoperation"));
renderTablePageRowselectioncustom(ReactDOM, document.getElementById("TablePageRowselectioncustom"));
...
<div className="card" id="components-table-demo-custom-filter-panel">
  <div className="card-header">
    <h5 className="mb-0 mr-3 d-inline-block text-black">
      <strong>Customized filter panel
 </strong>
    </h5>
  </div>
  <div className="card-body">
...
<div className="card" id="components-table-demo-reset-filter">
  <div className="card-header">
    <h5 className="mb-0 mr-3 d-inline-block text-black">
      <strong>Reset filters and sorters
 </strong>
    </h5>
  </div>
  <div className="card-body">
...
<div className="card" id="components-table-demo-fixed-columns-header">
  <div className="card-header">
    <h5 className="mb-0 mr-3 d-inline-block text-black">
      <strong>Fixed Columns and Header
 </strong>
    </h5>
  </div>
  <div className="card-body">
...
<div className="card" id="components-table-demo-row-selection-and-operation">
  <div className="card-header">
    <h5 className="mb-0 mr-3 d-inline-block text-black">
      <strong>Selection and operation
 </strong>
    </h5>
  </div>
  <div className="card-body">
