...
renderPaginationTotal(ReactDOM, document.getElementById("PaginationTotal"));
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <a href="https://ant.design/components/pagination/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Basic pagination.
</div>
...
<div className="card card--example" id="components-pagination-demo-controlled">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Controlled page number.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-pagination-demo-jump">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Jump to a page directly.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-pagination-demo-more">
  <div className="card-header">
    ...
    <div className="card-body pb-0">More pages.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-pagination-demo-total">
  <div className="card-header">
    ...
    <div className="card-body pb-0">You can show the total number of data by setting <code>{'showTotal'}</code>.
</div>
    <div className="card-body pb-0">
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Change <code>{'pageSize'}</code>.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-pagination-demo-itemRender">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Use text link for prev and next button.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-pagination-demo-mini">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Mini size pagination.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-pagination-demo-simple">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Simple mode.
</div>
    <div className="card-body pb-0">
