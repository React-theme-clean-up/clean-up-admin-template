...
renderAlertStyle(ReactDOM, document.getElementById("AlertStyle"));
            ...
            <div className="card">
              <div className="card-header">
                <h5 className="mb-0 mr-3 d-inline-block text-black">
                  <strong>Alert</strong>
                  <a href="https://ant.design/components/alert/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-2">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">Display Alert as a banner at top of page.
</div>
...
<div className="card" id="components-alert-demo-closable">
  <div className="card-header">
    ...
    <div className="card-body pb-0">To show close button.
</div>
    <div className="card-body pb-0">
...
<div className="card" id="components-alert-demo-description">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Additional description for alert message.
</div>
    <div className="card-body pb-0">
...
<div className="card" id="components-alert-demo-smooth-closed">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Smoothly and unaffectedly unmount Alert.
</div>
    <div className="card-body pb-0">
...
`}
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">The simplest usage for short messages.
</div>
    <div className="card-body pb-0">
      <div id="AlertBasic" />
    </div>
...
<div className="card" id="components-alert-demo-close-text">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Replace the default icon with customized text.
</div>
    <div className="card-body pb-0">
...
<div className="card" id="components-alert-demo-icon">
  <div className="card-header">
    ...
    <div className="card-body pb-0">Decent icon make information more clear and more friendly.
</div>
    <div className="card-body pb-0">
      <div id="AlertIcon" />
    </div>
...
<div className="card" id="components-alert-demo-style">
  <div className="card-header">
    ...
    <div className="card-body pb-0">There are 4 types of Alert: <code>{'success'}</code>, <code>{'info'}</code>, <code>{'warning'}</code>, <code>{'error'}</code>.
</div>
    <div className="card-body pb-0">
      <div id="AlertStyle" />
    </div>
