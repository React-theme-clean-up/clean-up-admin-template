...
renderCascaderPageChangeonselect(ReactDOM, document.getElementById("CascaderPageChangeonselect"));
...
renderCascaderPageDisabledoption(ReactDOM, document.getElementById("CascaderPageDisabledoption"));
