...
class FormPageItems extends React.Component {
  componentDidMount() {
    ...
    renderFormPageCustomizedformcontrols(
      ReactDOM,
      document.getElementById('FormPageCustomizedformcontrols'),
    )
    ...
    renderFormPageTimerelatedcontrols(
      ReactDOM,
      document.getElementById('FormPageTimerelatedcontrols'),
    )
