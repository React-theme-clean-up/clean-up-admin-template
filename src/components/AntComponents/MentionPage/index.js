...
renderMentionPageControlldersimple(ReactDOM, document.getElementById("MentionPageControlldersimple"));
...
renderMentionPageMultipletrigger(ReactDOM, document.getElementById("MentionPageMultipletrigger"));
