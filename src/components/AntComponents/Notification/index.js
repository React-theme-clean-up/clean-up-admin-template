...
renderNotificationWithicon(ReactDOM, document.getElementById("NotificationWithicon"));
            ...
            <div className="card">
              <div className="card-header">
                <div className="utils__title">
                  ...
                  <a href="https://ant.design/components/notification/" target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-primary ml-4">
  ...
  <div className="card-header">
    ...
    <div className="card-body pb-0">The simplest usage that close the notification box after 4.5s.
</div>
...
<div className="card card--example" id="components-notification-demo-custom-style">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize">Customized style</strong>
    </h5>
  </div>
    <div className="card-body pb-0">The style and className are available to customize Notification.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-notification-demo-placement">
  <div className="card-header">
    ...
    <div className="card-body pb-0">A notification box can pop up from <code>{'topRight'}</code> or <code>{'bottomRight'}</code> or <code>{'bottomLeft'}</code> or <code>{'topLeft'}</code>.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-notification-demo-with-icon">
  <div className="card-header">
    ...
    <div className="card-body pb-0">A notification box with a icon at the left side.
</div>
    <div className="card-body pb-0">
...
`}
                  ...
                  <div className="col-xl-6 col-lg-12">
                    <div className="card card--example" id="components-notification-demo-custom-icon">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize">Customized Icon</strong>
    </h5>
  </div>
    <div className="card-body pb-0">The icon can be customized to any react node.
</div>
    <div className="card-body pb-0">
...
<div className="card card--example" id="components-notification-demo-duration">
  <div className="card-header">
    <h5 className="text-black">
      <strong className="text-capitalize">Duration after which the notification box is closed</strong>
    </h5>
  </div>
    <div className="card-body pb-0"><code>{'Duration'}</code> can be used to specify how long the notification stays open. After the duration time elapses,
...
<div className="card card--example" id="components-notification-demo-with-btn">
  <div className="card-header">
    ...
    <div className="card-body pb-0">To customize the style or font of the close button.
</div>
    <div className="card-body pb-0">
