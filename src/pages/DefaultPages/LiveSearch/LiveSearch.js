        ...
        <div className="container-fluid">
          <div className="livesearch__wrapper">
            ...
            <div className="livesearch__search">
              <input type="search" className="livesearch__input" value={searchText} onChange={this.changeSearchText} id="livesearchInput" placeholder="Search..." ref={ele => (this.searchInput = ele)}/>
            </div>
            <ul className="livesearch__options">
              ...
              <li className="livesearch__option">
            ...
            <div className="livesearch__suggestion">
              <span className="livesearch__suggestion-text">
                Suggestion:
                <span className="livesearch__suggestion-input-text ml-1">
                  Some text
                </span>
              </span>
            </div>
              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="livesearch__result-content">
                    <div className="livesearch__result-thumb" style={{backgroundImage: "url(resources/images/photos/7.jpeg)"}}>
                      #1
                    </div>
                  ...
                  <div className="livesearch__result-content">
                    <div className="livesearch__result-thumb" style={{backgroundImage: "url(resources/images/photos/9.jpeg)"}}>
                      KF
                    </div>
                    <div className="livesearch__result">
                      <div className="livesearch__result-text">
                  ...
                  <div className="livesearch__result-content">
                    <div className="livesearch__result-thumb" style={{backgroundImage: "url(resources/images/photos/8.jpeg)"}}>
                      GF
                    </div>
                    <div className="livesearch__result">
                      <div className="livesearch__result-text">
                ...
                <div className="col-lg-4">
                  <div className="livesearch__result-content">
                    <div className="livesearch__result-thumb">
                      01
                    </div>
                    <div className="livesearch__result">
                      <div className="livesearch__result-text">
