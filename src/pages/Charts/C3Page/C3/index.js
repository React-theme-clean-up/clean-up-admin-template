    ...
    return (
      <section className="card">
        ...
        <span className="cat__core__title">
            <strong>C3</strong>
            <a href="http://c3js.org/" target="_blank" className="btn btn-sm btn-primary ml-2">Official Documentation <i className="icmn-link ml-1"></i></a>
        </span>
        </div>
        <div className="card-body">
          <div className="row">
            <div className="col-lg-6">
              <h5 className="text-black"><strong>Simple Line</strong></h5>
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
                <C3Chart data={line.data} color={line.color} axis={line.axis} grid={line.grid} />
              </div>
            </div>
            <div className="col-lg-6">
              <h5 className="text-black"><strong>Spline</strong></h5>
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
          ...
          <div className="row">
            <div className="col-lg-6">
              <h5 className="text-black"><strong>Step</strong></h5>
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <h5 className="text-black"><strong>Bar</strong></h5>
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
                <C3Chart data={stackedBar.data} color={stackedBar.color} bar={stackedBar.bar} grid={stackedBar.grid} />
              </div>
            </div>
            <div className="col-lg-6">
              <h5 className="text-black"><strong>Combination</strong></h5>
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
          ...
          <div className="row">
            <div className="col-lg-6">
              <h5 className="text-black"><strong>Sub Chart</strong></h5>
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
            ...
            <div className="col-lg-6">
              <h5 className="text-black"><strong>Zoom</strong></h5>
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
          ...
          <div className="row">
            <div className="col-lg-6">
              <h5 className="text-black"><strong>Pie Chart</strong></h5>
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
            ...
            <div className="col-lg-6">
              <h5 className="text-black"><strong>Donut Chart</strong></h5>
              <p className="text-muted">Element: read <a href="http://c3js.org/" target="_blank">official documentation<small><i className="icmn-link ml-1"></i></small></a></p>
              <div className="mb-5">
